 ...
 * l'historique.
 *
 * <p>Les lectures peuvent contourner l'agrégat, les écritures jamais (proposition d'architecture,
 * DA-12). Ce type appartient donc à la couche applicative et n'est pas un objet du domaine.
 */
